...
var IS_CIRCLE_GLOW = Math.random() < 0.5;
var IS_CIRCLE_GLOW_PER_CIRCLE = void 0;
...
var CIRCLE_GLOW_OPACITY = getRandomNumber(1, 10) / 10;
...
if (LAYOUT === 'confetti') {
  createCircle = function createCircle() {
    ...
    if (IS_CIRCLE_GLOW) {
      var boxShadowColor = color.replace('rgb', 'rgba').replace(')', ',' + (IS_CIRCLE_GLOW_OPACITY_PER_CIRCLE ? getRandomNumber(5, 10) / 10 : CIRCLE_GLOW_OPACITY) + ')');

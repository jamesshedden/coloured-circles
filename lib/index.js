...
var DIRECTION_INCREMENTS = (_DIRECTION_INCREMENTS = {}, _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.TOP, {
  top: SNAKE_ANGLE,
  left: 0
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.RIGHT, {
  top: 0,
  left: SNAKE_ANGLE
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.BOTTOM, {
  top: -SNAKE_ANGLE,
  left: 0
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.LEFT, {
  top: 0,
  left: SNAKE_ANGLE
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.TOP_RIGHT, {
  top: -SNAKE_ANGLE,
  left: SNAKE_ANGLE
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.BOTTOM_RIGHT, {
  top: SNAKE_ANGLE,
  left: SNAKE_ANGLE
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.BOTTOM_LEFT, {
  top: SNAKE_ANGLE,
  left: -SNAKE_ANGLE
}), _defineProperty(_DIRECTION_INCREMENTS, AVAILABLE_SNAKE_DIRECTIONS.TOP_LEFT, {
  top: -SNAKE_ANGLE,
  left: -SNAKE_ANGLE
}), _DIRECTION_INCREMENTS);
...
if (IS_CIRCLE_COLOR_INCREMENTAL) {
  colors = [].concat(_toConsumableArray(Array(getRandomNumber(1, 50)))).map(function () {

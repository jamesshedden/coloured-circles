...
var getRandomRgbColor = function getRandomRgbColor(min, max) {
  min = min || 0;
  max = max || 255;
...
var getRandomBackgroundColor = function getRandomBackgroundColor() {
  return getRandomRgbColor(50, 175);
};

var getRandomBackgroundGradient = function getRandomBackgroundGradient() {
